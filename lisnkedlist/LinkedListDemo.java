...
//		System.out.println();
//	}
	public static void convertToArrayList(LinkedList list) {
		ArrayList list1=new ArrayList(list);
		System.out.println(list1);
	}
	public static void containsAnElement(LinkedList list,Object o) {
		System.out.println(list.contains(o));
	}
	public static void retriveLastElement(LinkedList list) {
